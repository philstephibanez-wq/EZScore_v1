...
/**
 * Native Symfony authorization for Group resources.
 *
 * ROLE_* answers the global role question.
 * GroupMember answers the contextual condition question.
 */
final class GroupVoter extends Voter
{
    ...
    protected function voteOnAttribute(string $attribute, mixed $subject, TokenInterface $token): bool
    {
        ...
        return match ($attribute) {
            ...
            AclPrivilege::GROUP_EDIT,
            AclPrivilege::GROUP_MANAGE_MEMBERS => in_array($membership->getRole(), ['owner', 'manager'], true),
            AclPrivilege::GROUP_DELETE,
            AclPrivilege::GROUP_DELEGATE => $membership->getRole() === 'owner',
            default => false,
        };
    }
}
